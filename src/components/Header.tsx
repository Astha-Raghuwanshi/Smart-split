            ...
            >
                <DialogTitle id="scroll-dialog-title">
                    <Typography display="flex" alignItems="center" justifyContent="center">
                        <VerticalSplit />
                        <Typography ml="0.65rem" fontWeight="bold" variant="h6">Smart Spilt</Typography>
                    </Typography>
                </DialogTitle>
                <DialogContent dividers={true}>
                    <DialogContentText marginBottom="12px">
                        Split expenses among friends with ease
                    </DialogContentText>
                    <DialogContentText>
                        Add users.
                        Add payment made by each user.
                        Get details of the amount that one owes to the other.
                    </DialogContentText>
                    <DialogContentText marginTop="24px" textAlign="right">
                        <sub>
                            Build by Astha Raghuwanshi
                        </sub>
                    </DialogContentText>
                </DialogContent>
            </Dialog>
